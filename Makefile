...
macosx : OS := MACOSX
macosx : TARGET := ej2d
macosx : CFLAGS += -I/usr/include  -I3rd/freetype2/include/ -I3rd/glfw3/include/ $(shell freetype-config --cflags) -D __MACOSX
macosx : LDFLAGS += -L3rd/glfw3/lib/mac -lglfw3  -framework OpenGL -framework CoreFoundation -framework CoreGraphics -framework CoreVideo -framework IOKit -framework AppKit -framework Carbon -L3rd/freetype2/lib/mac -lfreetype -lm -ldl
